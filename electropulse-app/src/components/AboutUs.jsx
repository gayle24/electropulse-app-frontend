...
function AboutUs() {
  return (
    <div className='container fw-bolder bg-secondary'>
      ...
      <p>Our mission is to empower you with the tools and gadgets that make your daily life more enjoyable and efficient. Whether you're a tech-savvy enthusiast or just starting your journey into the digital world, we're here to serve you with expertise, passion, and a dedication to customer satisfaction.</p>
